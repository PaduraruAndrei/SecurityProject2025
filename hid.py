...
def ascii_to_hid(c):
  if c >= 'a' and c <= 'z':
    ...
    return (Key.Enter,)
  # Add the possibility to inject some special characters used in shell scripts
  elif c == '>':
    return (Key.Dot, Key.LeftShift, Mod.LeftShift)
  elif c == '|':
    return (Key.BackSlash, Key.LeftShift, Mod.LeftShift)
  elif c == '&':
    return (Key._7, Key.LeftShift, Mod.LeftShift)
  else:
