...
def initialize_bluetooth_adapter(interface, target):
    ...
    adapter.set_name("Earphones")  # Default: Robot
...
if __name__ == "__main__":
    ...
    # Must initialize these variables for finally,
    # for when try block fails and jump to finally
    adapter = None
    client = None
    profile_proc = None
